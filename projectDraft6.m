...
[initialSound,fsRateInitial]=audioread("/Volumes/a1911292/Programming/Project/initial.mp3");
initialSoundPlay=audioplayer(initialSound,fsRateInitial);

%refernce- matlab documentation- play(playerObj)
play(initialSoundPlay);
...
pause(2);
disp("Rules for this game are: ");
pause(1);
fprintf("1. You have to guess the name of the song (based on the music genre and language you select). \n");
fprintf("2. The earlier you guess, more the points you get. \n3. You will have 6 chances to guess the song. \n");
pause(2);
fprintf("DISCLAIMER- Don't include any whitespaces while giving in the input and enter the correct spellings. \n");
pause(2);
fprintf("Good Luck!! \n");
pause(6);
...
play(buttonSound);
userName=input("Kindly enter your name: ","s");
...
if strcmpi(musicLanguage,"english")
    ...
    while ~strcmpi(difficultyLevel,"easy") && ~strcmpi(difficultyLevel,"medium") && ~strcmpi(difficultyLevel,"hard") && ~strcmpi(difficultyLevel,"deadly")
        ...
        difficultyLevel=input("Enter a difficulty level (easy, medium, hard or deadly) : ");
    end
    ...
    while ~strcmpi(difficultyLevel,"normal") && ~strcmpi(difficultyLevel,"survival")
        ...
        difficultyLevel=input("Enter a difficulty level (normal or deadly) : ");
    end
